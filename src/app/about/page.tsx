          ...
          <div className="max-w-xl mx-auto glass-card rounded-2xl p-8">
            <div className="space-y-5">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="text-sm font-medium text-white">Polarbit Solutions Limited</div>
              ...
              <div className="border-t border-[var(--border)] pt-5 grid grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="text-sm font-mono font-medium text-white">C10001398</div>
                </div>
                <div>
                  <div className="text-xs text-[var(--text-muted)] mb-1">Incorporation No.</div>
                  <div className="text-sm font-mono font-medium text-white">BC1547199</div>
                </div>
              </div>
            </div>
          </div>
