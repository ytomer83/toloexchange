    ...
    <div className="min-h-screen py-12" style={{ background: 'var(--bg-primary)' }}>
      <div className="max-w-4xl mx-auto px-4 lg:px-6">
        ...
        <div className="glass-card rounded-2xl p-8 space-y-6 text-sm text-[var(--text-secondary)] leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">4. Services</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">5. Trading Rules</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">6. Fees</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">7. Deposits and Withdrawals</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">8. Prohibited Activities</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">9. Risk Disclosure</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">11. Governing Law</h2>
