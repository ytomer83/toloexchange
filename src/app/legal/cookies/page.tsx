    ...
    <div className="min-h-screen py-12" style={{ background: 'var(--bg-primary)' }}>
      <div className="max-w-4xl mx-auto px-4 lg:px-6">
        ...
        <div className="glass-card rounded-2xl p-8 space-y-6 text-sm text-[var(--text-secondary)] leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-white mb-3">2. Types of Cookies We Use</h2>
            <ul className="space-y-3 mt-2">
              <li><strong className="text-white">Essential Cookies:</strong> Required for the platform to function properly. These cannot be disabled.</li>
              <li><strong className="text-white">Performance Cookies:</strong> Help us understand how visitors interact with the platform to improve performance.</li>
              <li><strong className="text-white">Functional Cookies:</strong> Remember your preferences such as language and region.</li>
              <li><strong className="text-white">Analytics Cookies:</strong> Collect anonymized data about platform usage for statistical analysis.</li>
            </ul>
          </section>
