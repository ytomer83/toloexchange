  ...
  return (
    <div className="min-h-screen py-12" style={{ background: 'var(--bg-primary)' }}>
      <div className="max-w-4xl mx-auto px-4 lg:px-6">
        <h1 className="text-3xl font-bold text-[var(--text-primary)] mb-2">Anti-Money Laundering (AML) Policy</h1>
        ...
        <div className="glass-card rounded-2xl p-8 space-y-6 text-sm text-[var(--text-secondary)] leading-relaxed">
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">1. Purpose</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">2. Regulatory Framework</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">3. Know Your Customer (KYC)</h2>
            <p>All users must complete identity verification before accessing our services. Our KYC procedures include:</p>
            <ul className="list-disc ml-6 mt-2 space-y-1">
              <li><strong className="text-[var(--text-primary)]">Identity Verification:</strong> Government-issued photo ID (passport, national ID, or driver&apos;s license)</li>
              <li><strong className="text-[var(--text-primary)]">Address Verification:</strong> Proof of residential address (utility bill, bank statement, or government letter)</li>
              <li><strong className="text-[var(--text-primary)]">Enhanced Due Diligence:</strong> Additional verification for high-risk customers, including source of funds documentation</li>
              <li><strong className="text-[var(--text-primary)]">Ongoing Monitoring:</strong> Continuous monitoring of customer transactions and activities</li>
            </ul>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">4. Customer Due Diligence (CDD)</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">5. Transaction Monitoring</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">6. Sanctions Screening</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">7. Politically Exposed Persons (PEPs)</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">8. Suspicious Activity Reporting</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">9. Record Keeping</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-3">10. Employee Training</h2>
