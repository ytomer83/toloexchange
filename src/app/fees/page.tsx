    ...
    <div className="min-h-screen py-12" style={{ background: 'var(--bg-primary)' }}>
      <div className="max-w-[900px] mx-auto px-4 lg:px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-sm text-[var(--text-secondary)]">Simple, transparent pricing for all swaps</p>
        </div>
        ...
        <div className="mb-12">
          <div className="glass-card rounded-2xl p-8 text-center">
            ...
            <div className="text-lg text-[var(--text-secondary)] mb-6">Flat fee on all swaps</div>
            <div className="max-w-md mx-auto space-y-3">
              <div className="flex justify-between text-sm py-2 border-b border-[var(--border)]">
                ...
                <span className="text-white font-medium">Flat rate — same for all tokens</span>
              </div>
              <div className="flex justify-between text-sm py-2 border-b border-[var(--border)]">
        ...
        <div className="mb-12">
          ...
          <div className="glass-card rounded-xl p-6">
            <div className="space-y-3">
              ...
              <div className="flex justify-between text-sm">
                <span className="text-[var(--text-secondary)]">Fee (0.5%)</span>
                <span className="text-[var(--text-muted)]">-5.00 USDT</span>
              </div>
              <div className="border-t border-[var(--border)] pt-3 flex justify-between text-sm">
                ...
                <span className="text-white font-semibold">995.00 USDT</span>
              </div>
            </div>
          </div>
          <div className="flex items-start gap-2 mt-3 text-xs text-[var(--text-muted)]">
            <Info className="w-4 h-4 shrink-0 mt-0.5" />
            <p>Rates are determined at the time of swap. The 0.5% fee is deducted from the output amount. Network gas fees may apply depending on the blockchain.</p>
          </div>
        </div>
        ...
        <div className="glass-card rounded-xl p-6">
          ...
          <p className="text-xs text-[var(--text-secondary)] leading-relaxed">
            TOLO supports swapping between 20+ digital assets including USDC, USDT, ETH, BTC, SOL, BNB, DAI, XRP, MATIC, AVAX, DOT, LINK, ADA, DOGE, UNI, AAVE, ARB, OP, LTC, SHIB, and more. All tokens are subject to the same flat 0.5% fee.
          </p>
        </div>
      </div>
    </div>
